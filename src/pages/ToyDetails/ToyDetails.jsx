...
const ToyDetails = () => {
  ...
  return (
    <div className="flex w-2/3 mx-auto p-10 rounded-xl items-center border justify-center space-x-10 bg-slate-200">
      ...
      <div className="border w-1/3  space-y-8 text-slate-700">
